...
posterior_samples_all_model2 = rstan::extract(fit_Model_TIV , pars = c("theta_WT",'sigma'), inc_warmup = TRUE, permuted = FALSE)
posterior_samples_merged_after_burnin_model2 = rstan::extract(fit_Model_TIV , pars = c( "theta_WT",'sigma'))

color_scheme_set("brewer-Spectral")
mcmc_trace(posterior_samples_all_model2, n_warmup = 1250,
           facet_args = list(nrow = 4, labeller = label_parsed))

# show all marginal posterior distributions
posterior_sample_table_model2 = data.frame(epsilon1 = posterior_samples_merged_after_burnin_model2$theta_WT[,1],
                                           #k1 = posterior_samples_merged_after_burnin$theta[,2],
                                           beta = posterior_samples_merged_after_burnin_model2$theta_WT[,2],
                                           delta_I = posterior_samples_merged_after_burnin_model2$theta_WT[,3],
                                           p = posterior_samples_merged_after_burnin_model2$theta_WT[,4],
                                           delta_V = posterior_samples_merged_after_burnin_model2$theta_WT[,5],
                                           kappa_M = posterior_samples_merged_after_burnin_model2$theta_WT[,6],
                                           ...
                                           epsilon2 = posterior_samples_merged_after_burnin_model2$theta_WT[,7],
                                           #k2 = posterior_samples_merged_after_burnin$theta[,9],
                                           delta_M = posterior_samples_merged_after_burnin_model2$theta_WT[,8],
                                           phi = posterior_samples_merged_after_burnin_model2$theta_WT[,9],
                                           I_50 = posterior_samples_merged_after_burnin_model2$theta_WT[,10])
...
ggplot(posterior_sample_table_model2, aes(x = epsilon1)) + 
...
ggplot(posterior_sample_table_model2, aes(x = log10(kappa_M))) + 
...
write.csv(posterior_samples_merged_after_burnin_model2, file="Muc1_good_fit2_NOV_5.csv")
